...
export class WGLContext{
    ...
    public static InitWidthCanvas(canvas: HTMLCanvasElement): WGLContext{

        let wgl:WebGLRenderingContext |WebGL2RenderingContext = canvas.getContext('webgl2');
        if(wgl == null){
        ...
        let wglrender = new WGLContext(wgl);
        return wglrender;
    }
    public static InitWidthWGL(wgl:WebGLRenderingContext | WebGL2RenderingContext) :WGLContext{
