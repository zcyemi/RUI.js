...
export class RUIPageBasis extends RUIContainer {
    ...
    public PageBasicResize(parent: RUIContainer) {
        ...
        container.boxBackground = RUIColor.RED;
        container.width = 200;
